...
/**
 * EDITED by ELESBB to create a fully customizable gesture detector
 * Originally sourced from Google
 *
 ...
 *  <li>In the  method ensure you call
...
public class CustomGestureDetector {
    ...
    public interface OnGestureListener {
        ...
        void onDoubleTapFling(MotionEvent e1, float velocityX, float velcoityY);
    }
    ...
    public static class SimpleOnGestureListener implements OnGestureListener, OnDoubleTapListener,
        ...
        @Override
        public void onDoubleTapFling(MotionEvent e1, float velocityX, float velcoityY) {
    ...
    private int mCustomDoubleTap = DOUBLE_TAP_TIMEOUT;

    public void SetDoubleTapTimeout(int duration) {
        mCustomDoubleTap = duration;
    }
     ...
     *
     * @deprecated Use {#GestureDetector(Context, GestureDetector.OnGestureListener, Handler)}
     * instead.
     */
    @Deprecated
    public CustomGestureDetector(@NonNull OnGestureListener listener, @Nullable Handler handler) {
     ...
     * @throws NullPointerException if {@code listener} is null.
     *
     * @deprecated Use { #GestureDetector(Context, GestureDetector.OnGestureListener)} instead.
     */
    @Deprecated
    public CustomGestureDetector(@NonNull OnGestureListener listener) {
    ...
    public CustomGestureDetector(@Nullable @UiContext Context context,
            ...
            case MotionEvent.ACTION_DOWN:
                if (mDoubleTapListener != null) {
                    ...
                    if ((mCurrentDownEvent != null) && (mPreviousUpEvent != null)
                        ...
                        // This is a first tap
                        mHandler.sendEmptyMessageDelayed(TAP, mCustomDoubleTap);
//                        mHandler.sendEmptyMessage(TAP);
                        ...
                        if (distance > slopSquare) {
                            ...
                            mHandler.sendMessageAtTime(
                                    mHandler.obtainMessage(
                                            ...
                                            0 /* arg2 */),
                                    ev.getDownTime()
                                            + (long) ((long) LONGPRESS_TIMEOUT * mAmbiguousGestureMultiplier));
                        }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mIsDoubleTapping) {
                    ...
                    if ((Math.abs(velocityY) > mMinimumFlingVelocity)
                        ...
                        mListener.onDoubleTapFling(mCurrentDownEvent, velocityX, velocityY);
                    }
    ...
    private boolean isConsideredDoubleTap(@NonNull MotionEvent firstDown,
        ...
        if (deltaTime > mCustomDoubleTap || deltaTime < DOUBLE_TAP_MIN_TIME) {
            return false;
        }
